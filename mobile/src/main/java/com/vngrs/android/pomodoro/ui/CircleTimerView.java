...
public class CircleTimerView extends View {
    ...
    private void init(Context c) {
        ...
        mWhiteColor = resources.getColor(R.color.ongoing_red_dark);
        mAccentColor = resources.getColor(android.R.color.white);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mIntervalStartTime == -1) {
            ...
            if (mAnimate) {
                mCurrentIntervalTime = System.currentTimeMillis() - mIntervalStartTime + mAccumulatedTime;
            }
